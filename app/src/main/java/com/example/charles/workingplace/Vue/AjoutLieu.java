    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ajoutLieu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!adresse.getText().toString().equals("") && !ville.getText().toString().equals("")&& !codepostal.getText().toString().equals("") && !description.getText().toString().equals("") && !capacite.getText().toString().equals("")){
                    controleur.creerLieu(adresse.getText().toString(),ville.getText().toString(), Integer.parseInt(codepostal.getText().toString()), Integer.parseInt(capacite.getText().toString()), description.getText().toString());
