...
public class Controleur {
    ...
    public Lieu creerLieu(String adresse, String ville, int codepostale, int capacite, String description) {

        Lieu lieu = new Lieu(adresse, ville, codepostale, capacite, description, id);
